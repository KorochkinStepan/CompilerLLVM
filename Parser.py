...
def p_identifierList(p):  # DECLARATIONS / IdentifierList
    '''identifierList : ID
...
def p_subDeclarations(p):  # SUBDECLARATIONS
    '''subDeclarations :
...
def p_subDeclaration(p):  # SUBDECLARATIONS / SubDeclaration
...
def p_comStatement(p):  # COMPOUNDSTATEMENT
